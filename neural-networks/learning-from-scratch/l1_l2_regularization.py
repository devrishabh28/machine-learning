...
#  Create a dense layer with 2 input features and 512 output values.
dense1 = layer.LayerDense(
    2, 512, weight_regularizer_l1=1e-7, bias_regularizer_l1=1e-7, weight_regularizer_l2=5e-4, bias_regularizer_l2=5e-4)
...
#  Create optimizer
optimizer = optimizers.Adam(learning_rate=0.03, decay=5e-7)
